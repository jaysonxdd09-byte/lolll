    ...
    <section id="blogs" className="py-14 sm:py-20 bg-white">
      <div className="max-w-[95%] mx-auto px-4 sm:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 sm:mb-12 gap-4">
          <div>
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-primary-500">Insights</span>
            <h2 className="text-2xl sm:text-4xl font-serif text-gray-900 mt-3">Latest <span className="text-primary-600">Blogs</span></h2>
          </div>
          <button onClick={onViewAll} className="group flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-primary-600 transition-colors">
              ...
              >
                ...
                <div className="p-4 sm:p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold text-primary-600 flex items-center gap-1">Read <ArrowRight className="w-3.5 h-3.5" /></span>
                  </div>
                </div>
              </article>
            ))}
