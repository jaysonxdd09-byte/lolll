...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (msg.includes('popup-blocked') || msg.includes('cancelled-popup-request') || msg.includes('popup-closed-by-user')) {
        setError('Popup was blocked or closed. Please allow popups for this site, or try Email Sign In instead.');
      } else {
            ...
            <div className="p-10 lg:p-12">
              ...
              <div className="grid grid-cols-1 gap-4 mb-8">
                <button 
                  ...
                  className="flex items-center justify-center gap-3 w-full py-4 px-6 bg-white border border-gray-100 rounded-2xl text-sm font-bold text-gray-700 hover:bg-gray-50 hover:border-primary-200 transition-all shadow-sm"
                >
              ...
              <form onSubmit={handleAuth} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-14 pr-6 py-4 bg-gray-50 border border-transparent rounded-2xl text-sm focus:bg-white focus:border-primary-500 transition-all outline-none"
                    />
                  </div>
                </div>
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gray-900 hover:bg-primary-600 text-white py-5 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all shadow-xl shadow-gray-900/10 flex items-center justify-center gap-3 disabled:opacity-50"
                >
