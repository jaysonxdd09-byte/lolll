...
import { Download, Eye, Shield, Globe, Verified, CheckCircle, FileText } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-32 pb-24">
      ...
      <div className="max-w-[95%] mx-auto px-8 mb-16">
        <BackButton onBack={onBack} label="Back to Store" className="mb-8" />

        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-gray-200 pb-12">
          <div className="max-w-2xl">
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-primary-500 mb-4 block">Official Documentation</span>
            <h1 className="text-5xl lg:text-6xl font-serif text-gray-900 mb-6">Our <span className="text-primary-600">Certifications</span></h1>
      ...
      <div className="max-w-[95%] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {certificates.map((cert, index) => (
            <motion.div
              ...
              className="bg-white rounded-[40px] overflow-hidden border border-gray-100 shadow-xl hover:shadow-2xl hover:shadow-primary-500/5 transition-all duration-700 group"
            >
              <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="md:w-1/2 p-8 lg:p-12 flex flex-col">
                  <div className="flex-1">
                    <div className="w-12 h-12 bg-primary-50 rounded-2xl flex items-center justify-center text-primary-500 mb-6 group-hover:bg-primary-500 group-hover:text-white transition-all duration-500">
                  ...
                  <div className="pt-8 border-t border-gray-100 flex items-center justify-between gap-4">
                    <button 
                      ...
                      className="flex-1 bg-gray-900 text-white py-4 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-primary-600 transition-all shadow-lg shadow-gray-900/10 flex items-center justify-center gap-2"
                    >
        ...
        <div className="mt-20 text-center max-w-3xl mx-auto bg-white p-12 rounded-[40px] border border-gray-100 shadow-sm">
          <Globe className="w-12 h-12 text-primary-500 mx-auto mb-8" />
