        ...
        >
          <div className="relative max-w-sm w-full space-y-12 text-center">
            ...
            <div className="space-y-4">
              <div className="relative h-[2px] w-full bg-gray-100 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="absolute inset-y-0 left-0 bg-primary-500 shadow-[0_0_15px_rgba(234,179,8,0.4)]"
                />
              </div>
            ...
            <motion.p
              ...
              className="text-[10px] font-bold text-primary-600/60 uppercase tracking-[0.4em] pt-4"
            >
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-primary-50/50 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
        </motion.div>
      )}
    </AnimatePresence>
  );
