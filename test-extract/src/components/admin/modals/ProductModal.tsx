...
const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const fieldClass =
    'w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none transition-all disabled:opacity-60';
      ...
      <div className="bg-white rounded-3xl w-full max-w-3xl overflow-hidden shadow-2xl max-h-[90vh] flex flex-col">
        ...
        {!readOnly ? (
          <div className="p-6 bg-gray-50 border-t border-gray-100 flex gap-4 shrink-0">
            ...
            <button type="button" onClick={handleSubmit} disabled={isSubmitting} className="flex-1 px-6 py-3 bg-primary-600 text-white rounded-xl font-bold text-sm disabled:opacity-50 flex items-center justify-center gap-2">
