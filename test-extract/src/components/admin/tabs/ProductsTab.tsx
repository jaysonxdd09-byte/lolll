...
import { Plus, Edit2, Trash2, Image as ImageIcon, RefreshCw, Database, Save } from 'lucide-react';
    ...
    <div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button onClick={handleSync} disabled={syncing} className="px-4 py-2 rounded-lg border border-primary-200 bg-primary-50 text-primary-700 text-sm font-bold flex items-center gap-2 disabled:opacity-50">
            <Database className="w-4 h-4" /> {syncing ? 'Syncing...' : 'Sync Catalog to DB'}
          </button>
          <button onClick={() => { setSelectedProduct(null); setIsModalOpen(true); }} className="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2">
              ...
              <tr key={product.id} className="hover:bg-gray-50/50 group">
                ...
                <td className="px-4 py-3 text-right">
                  <div className="flex justify-end gap-1">
                    <button onClick={() => { setSelectedProduct(product); setIsModalOpen(true); }} className="p-2 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg"><Edit2 className="w-4 h-4" /></button>
