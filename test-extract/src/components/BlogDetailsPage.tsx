...
import { CalendarDays, User, Clock, Share2, Facebook, Twitter, Linkedin, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white pt-24 sm:pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-8">
        <BackButton onBack={onBack} label="Back to Journal" className="mb-8" />

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div className="flex flex-wrap items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-primary-500 mb-6">
            <span className="bg-primary-50 px-3 py-1 rounded-full">Medical Insights</span>
          ...
          <div className="flex items-center justify-between py-8 border-y border-gray-100 mb-10">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-primary-50 rounded-2xl flex items-center justify-center"><User className="w-5 h-5 text-primary-600" /></div>
              <div>
        ...
        <div className="prose prose-lg max-w-none prose-serif prose-gold">
          ...
          <div className="text-gray-700 leading-relaxed space-y-6 text-lg">
            ...
            <blockquote className="bg-gray-50 p-8 rounded-3xl border border-gray-100 my-12">
              ...
              <cite className="block mt-4 text-xs font-bold uppercase tracking-widest text-primary-600">— Clinical Procurement Review, 2024</cite>
            </blockquote>
        ...
        <div className="mt-20 pt-10 border-t border-gray-100">
          <div className="bg-primary-500 rounded-[32px] p-8 sm:p-12 text-white relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button className="bg-white text-primary-600 px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-gray-900 hover:text-white transition-all">Subscribe Now</button>
              </div>
            </div>
