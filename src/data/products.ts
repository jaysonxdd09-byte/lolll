...
export const products: Product[] = [
  // ================== TEST ONE SOLUTIONS INDIA PRODUCTS ==================
  {
    id: 'to0000000000001',
    name: 'C Arm Cover',
    price: 95,
    ...
    description: 'Sterile surgical C-arm cover designed for comprehensive medical imaging machinery. Excellent puncture resistance and sterile fluid barrier.',
    rating: 4.9,
    stock_quantity: 120
  },
  {
    ...
    description: 'Aseptic camera sheath cover for endoscopic, laproscopic, and arthroscopic video cameras. Preserves sterile field during high-precision surgery.',
    rating: 4.8,
    stock_quantity: 95
  },
  {
    ...
    description: 'Surgical cling drape with high-tack bio-compatible adhesive. Conforms perfectly to skin contours to isolate incision sites.',
    rating: 4.7,
    stock_quantity: 210
  },
  {
    ...
    description: 'Heavy duty, fluid-impermeable Orthopedic Knee O Drape. Features elastic fenestrations and built-in fluid collection pouch.',
    rating: 4.9,
    stock_quantity: 65
  },
  {
    ...
    description: 'Hip U-shaped drape with integrated adhesive strip. Protects patient and clinician from fluid spray during complex arthroplasty.',
    rating: 4.8,
    stock_quantity: 48
  },
  {
    ...
    description: 'Designed specifically for spine, laminectomy, and back procedures. Large fenestrations with premium security margins.',
    rating: 4.9,
    stock_quantity: 54
  },
  {
    id: 'to0000000000007',
    name: 'Full Gown (Cuff Around Wrap)',
    price: 145,
    ...
    gst: '5%',
    mrp: 599,
    image: '/images/surgical_gown_thumb.png',
    description: 'Test One signature premium wrap-around surgical gown. Features soft breathable SMS fabric, elastic knit cuffs, and full rear wrap coverage.',
    rating: 5.0,
    stock_quantity: 180
  },
  {
    ...
    description: 'Spunbond patient and clinician half gown. Ideal for short procedures, diagnostics, and patient prep.',
    rating: 4.6,
    stock_quantity: 320
  },
  {
    id: 'to0000000000009',
    name: 'Reinforced Gown',
    price: 194,
    category: 'Surgical Gown',
    brand: 'Test One',
    code: 'XP805',
    ...
    description: 'Heavy duty fluid-repellent reinforced isolation gown. Exceeds AAMI Level 4 parameters for critical fluid zones.',
    rating: 4.9,
    stock_quantity: 110
  },
  {
    ...
    description: 'Cardiac angiography drape with transparent side panels and dual femoral access points. Exceptional absorbency.',
    rating: 4.8,
    stock_quantity: 70
  },
  {
    id: 'to0000000000011',
    name: 'Angioplasty Drape',
    price: 553,
    category: 'Cardiac Drape',
    brand: 'Test One',
    code: 'XP412',
    ...
    description: 'Medical grade angioplasty drape. Preconfigured for radial and brachial access routes with soft drape material.',
    rating: 4.8,
    stock_quantity: 65
  },
  {
    id: 'to0000000000012',
    name: 'X-Test Delivery Drape Kit',
    price: 353,
    category: 'Surgical Kits',
    brand: 'Test One',
    gst: '5%',
    mrp: 852,
    image: '/images/surgical_drape_kit_thumb.png',
    description: 'All-in-one sterile childbirth delivery kit containing leggings, underbuttocks drape, sheets, and disposable clamps.',
    rating: 4.9,
    stock_quantity: 80
  },
  {
    id: 'to0000000000013',
    name: 'X-Test Ceaserian Drape Kit',
    price: 629,
    category: 'Surgical Kits',
    brand: 'Test One',
    gst: '5%',
    mrp: 1421,
    image: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&q=80&w=400',
    description: 'Obstetrics C-Section kit with custom fenestrated drape, integrated fluid collection pouch, and premium surgical gowns.',
    rating: 4.9,
    stock_quantity: 45
  },
  {
    id: 'to0000000000014',
    name: 'X-Test T.H.R Drape Kit',
    price: 2234,
    category: 'Surgical Kits',
    brand: 'Test One',
    gst: '5%',
    mrp: 4890,
    image: 'https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&q=80&w=400',
    description: 'High-end Total Hip Replacement sterile kit. Designed for absolute barrier security and large fluid containment.',
    rating: 5.0,
    stock_quantity: 30
  },
  {
    id: 'to0000000000015',
    name: 'X-Test T.K.R Drape Kit',
    price: 2237,
    category: 'Surgical Kits',
    brand: 'Test One',
    gst: '5%',
    mrp: 4896,
    image: 'https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&q=80&w=400',
    description: 'Total Knee Replacement surgical kit. Fully compliant with high fluid barrier standards in major ortho joints.',
    rating: 4.9,
    stock_quantity: 28
  },
  {
    id: 'to0000000000016',
    name: 'L.S.C.S Drape Kit',
    price: 743,
    category: 'Surgical Kits',
    brand: 'Test One',
    gst: '5%',
    mrp: 1860,
    image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=400',
    description: 'Lower Segment Caesarean Section sterile procedure kit. Features fluid collection bag with high tensile seals.',
    rating: 4.8,
    stock_quantity: 50
  },
  {
    id: 'to0000000000017',
    name: 'Laproscopy Drape Kit',
    price: 1063,
    category: 'Surgical Kits',
    brand: 'Test One',
    gst: '5%',
    mrp: 2350,
    image: 'https://images.unsplash.com/photo-1579684389782-64d84b5e901d?auto=format&fit=crop&q=80&w=400',
    description: 'Sterile multi-fenestration laparoscopy kit. Outfitted with absorbent armboard covers and skin preparation materials.',
    rating: 4.9,
    stock_quantity: 40
  },
  {
    id: 'to0000000000018',
    name: 'Microporous Paper Tape 1 inch',
    price: 15.5,
    ...
    description: 'Test One Microporous medical paper tape. Hypoallergenic adhesive is gentle on sensitive skin while securing IVs.',
    rating: 4.8,
    stock_quantity: 500
  },
  {
    id: 'to0000000000019',
    name: 'Microporous Paper Tape 2 inch',
    price: 31,
    category: 'Surgical Tapes',
    brand: 'Test One',
    code: 'XPORE1530-2',
    ...
    description: 'Double-wide 2-inch microporous medical paper tape. Strong cohesion for major dressings and clinical wrapping.',
    rating: 4.9,
    stock_quantity: 400
  },
